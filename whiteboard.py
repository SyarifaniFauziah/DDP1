...
#icon
image_icon=PhotoImage(file="foto/logo.png")
root.iconphoto(False,image_icon)

color_box=PhotoImage(file="foto/color section.png")
Label(root,image=color_box,bg="#f2f3f5").place(x=10,y=20)

eraser=PhotoImage(file="foto/eraser.png")
Button(root, image=eraser,bg="#f2f3f5", command=clear_canvas).place(x=30,y=400)
